...
hand-measured 1990 points land on our curves in both panels.  The full
digitized traces of the second coupling await per-series axis
calibration, and we do not overlay them.
...
traces calibrate to it.  Bottom: $2K = 100$, $\mathrm{LPN} = 6$, lowest 40
