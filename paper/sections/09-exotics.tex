...
character between $2K = 28$ and $32$, and the level table locates the
crossing exactly: the threshold baryon runs smoothly across it, while the
$B=2$ ground state switches identity between two eight-parton
momentum-partition configurations at coarse resolution.  The
post-crossing branch converges smoothly; we fit it alone and quote
